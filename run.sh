...
echo -e "${CYAN}=========================================================${NC}"
echo "=== Building FotoPanel Ecosystem: PWA + Astro + GCP ==="
echo -e "${CYAN}=========================================================${NC}"

mkdir -p src/styles src/scripts src/pages docs public/img
...
# 5. Astro Page Component with PWA Registration
cat << 'ASTRO_EOF' > src/pages/index.astro
---
...
# 6. GCP Cloud Run Container (Dockerfile)
...
echo -e "${GREEN}=== Ecosystem generated. Starting Local Dev Server... ===${NC}"
npm install
npm run dev